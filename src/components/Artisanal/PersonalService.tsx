  ...
  <section id="personal-service" className="container mx-auto px-4 py-16 max-w-5xl">
    <div className="bg-card rounded-3xl shadow-xl p-10 flex flex-col md:flex-row gap-10 items-center">
      ...
      <div className="flex-1">
        ...
        <p className="text-lg text-muted-foreground mb-4">From your first inquiry to the final farewell, Butterfly Bites catering is dedicated to making your event seamless, memorable, and uniquely yours. Experience the difference of true hospitality and attention to detail.</p>
        ...
        <div className="bg-gradient-to-r from-golden to-sage rounded-xl shadow p-6 mb-6">
          ...
          <p className="text-background">“Butterfly Bites made our anniversary dinner absolutely magical. Every detail was perfect, and our guests are still talking about the food and the warmth of the service.” <br /><span className="italic">— Sophia & Mark, San Francisco</span></p>
        </div>
